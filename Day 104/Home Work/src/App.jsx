  ...
  return (
    <section className="flex justify-center items-center pt-5">
      <main className="w-[70%] h-full flex flex-col items-center gap-20">
        ...
        <form className="w-full " onChange={counter}>
          <input name="text" value={text} onChange={(e) => setText(e.target.value)} className="bg-[#2A2B37] h-50 w-full focus:outline-0 text-[#E4E4EF] text-[20px] rounded-xl p-5 resize-none" type="text" placeholder="Start typing here… (or paste your text)"/>
          <div className="flex gap-10 items-center">
            <div className="flex gap-3 items-center">
              <input className="bg-transparent outline-amber-600" name="spaces"  type="checkbox"/>
              <label className="text-[#E4E4EF]" htmlFor="spaces">Exclude Spaces</label>

            </div>

            <div className="flex gap-3 items-center">
              <input className="" name="limit" type="checkbox"/>
              <label className="text-[#E4E4EF]" htmlFor="limit">Set Character Limit</label>
        ...
        <div className="flex gap-5 w-full">
          ...
          <div className="bg-[#D3A0FA] flex items-center justify-between w-full rounded-xl overflow-hidden">
            ...
            <div className="p-5 flex flex-col gap-3.75">
              <p className="text-[#12131A] text-7xl">{count}</p>
          ...
          <div className="bg-[#FF9F00] flex items-center justify-between w-full rounded-xl overflow-hidden">
            ...
            <div className="p-5 flex flex-col gap-3.75">
              <p className="text-[#12131A] text-7xl">0</p>
              <p className="text-[#12131A]">Total Characters</p>
            </div>
        ...
        <div className="flex justify-start w-full flex-col gap-5">
          <p className="text-2xl text-[#E4E4EF] font-semibold">Letter Density</p>
          <p className="text-[#E4E4EF] ">No characters found. Start typing to see letter density.</p>
        </div>
